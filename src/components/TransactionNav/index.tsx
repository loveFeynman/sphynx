...
const TransactionNav = () => {
  ...
  return (
    <>
      <StyledNav>
        <Button
          className={swapTransCard === 'tokenDX' ? 'active' : ''}
          id="tokendv-nav-link"
          onClick={() => {
            setSwapTransCard('tokenDX')
          }}
        >
          {t('Token DX')}
        </Button>
        <Button
          className={swapTransCard === 'buyers' ? 'active' : ''}
          id="transbuyer-nav-link"
          onClick={() => {
            setSwapTransCard('buyers')
          }}
        >
          {t('Buyers')}
        </Button>
        <Button
          className={swapTransCard === 'sellers' ? 'active' : ''}
          id="transseller-nav-link"
          onClick={() => {
            setSwapTransCard('sellers')
          }}
        >
          {t('Sellers')}
        </Button>
