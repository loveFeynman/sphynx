  ...
  ['chart-widget-gui'],
  {
        ...
        k = (function () {
          function t(t, e, i) {
            ;(this._widget = Object(s.ensureNotNull)(Object(l.a)(M).querySelector('.control-bar-wrapper'))),
              ...
              (this._back = Object(s.ensureNotNull)(Object(l.a)(C).querySelector('.control-bar__btn--back-present'))),
    ...
    sAH5: function (t, e, i) {
      ...
      var C = (function () {
          function t(t, e, i) {
            ...
            ;(this._withActions = i.withActions),
              ...
              null !== this._valuesParentEl && (this._loader = new v(this._valuesParentEl, { className: m.loader })),
              ...
              this._withActions &&
                ...
                (this._selectedSourceHandler = Object(b.c)(this._model.setSourceSelected.bind(this._model))),
          ...
          return (
            ...
            (t.prototype._renderTitle = function () {
              ...
              for (var t = this._titleParentEl, e = 0; e < this._titlesSpawns.length; e++) {
                ...
                i.classList.add(m.title, M[e], 'apply-overflow-tooltip'), (i.dataset.name = 'legend-source-title')
          ...
          function e(e, i, s) {
            ...
            return (
              ...
              s.withActions &&
                ...
                null !== o._titleParentEl && o._titleParentEl.addEventListener(V, o._wheelClickHandler)),
              o
            )
          }
          return (
          ...
          return (
            ...
            (t.prototype.addMainDataSource = function (t, e) {
              ...
              this._renderMainDataSourceEl(),
                (this._mainDataSourceRenderer = new E(t, Object(o.ensureNotNull)(this._mainDataSourceEl), {
          ...
          return (
              ...
              if (null !== t && 0 !== t.items().length) {
                ...
                if (0 === e.length) {
                  var i = t.items().map(function (t) {
                    return { value: new l.a(t.value()), color: new l.a(Y(t.color())), visible: new l.a(t.visible()) }
                  })
                  ...
                  for (var s = t.items(), o = 0; o < s.length; o++) {
                    var n = e[o],
                      a = s[o]
                    n.value.setValue(a.value()), n.color.setValue(Y(a.color())), n.visible.setValue(a.visible())
                  }
              }
            }),
            (e.prototype._updateStates = function () {
            ...
            (e.prototype._createActions = function () {
              ...
              if (!this._options.readOnlyMode) {
                ...
                ft &&
                  St &&
                  (!Object(rt.isStudy)(this._source) || new dt.a(this._source.metaInfo()).hasUserEditableOptions()) &&
                  this._actions.push({
                    iconMap: new Map([
                      ['large', ct],
                      ['small', ct],
      ...
      var Yt = Jt,
        ...
        pe = Object(Rt.b)(window.t('{listedExchange} real-time data is available for free to registered users.')),
        _e = Object(Rt.b)(window.t('To get real-time data for {description}, please buy the real-time data package.')),
        be = Object(Rt.b)(
        ...
        me = Object(Rt.b)(window.t('Data is updated once per second, even if there are more updates on the market.')),
                  ...
                  return Object(s.d)(this, function (s) {
                    switch (s.label) {
                      ...
                      case 3:
                        return (
                          (l = s.sent()),
                          se.logError("Can't get exchange description, reason: " + Object(qt.a)(l)),
                          [3, 4]
                        )
                      case 4:
                        for (a = 0, r = t; a < r.length; a++)
                          (u = r[a]),
                            ...
                            ('DelayToRealtime' !== u &&
                              ...
                              'TFEXDelayForGuest' !== u &&
                              'MOEXDelayForGuest' !== u) ||
                              (e[u].push(ce.format({ symbolName: i, time: this._model.time().toString() })),
                              this._options.subscriptionFullInfo &&
                                null !== o &&
                                'DelayToRealtime' === u &&
                                e[u].push(_e.format({ description: '<b>' + o + '</b>' })),
                              null !== o &&
                                'DelayNoRealtime' === u &&
                                e[u].push(be.format({ description: '<b>' + o + '</b>' })),
                              this._options.subscriptionFullInfo &&
                                (u.includes('TFEXDelayForGuest') || u.includes('MOEXDelayForGuest')) &&
                                e[u].push(pe.format({ listedExchange: this._model.listedExchange() }))),
                            'EOD' === u && (e[u] = [ge]),
                            'TickByTick' === u &&
                  ...
                  for (var s = 0, o = i; s < o.length; s++) {
                    ...
                    ;(t = n),
                      ...
                      (e = Ut.getJSON('tv.alreadyBlinkedStatuses', Xt)).includes(t) ||
                        (e.push(t), Ut.setJSON('tv.alreadyBlinkedStatuses', e), Jt.setValue(Zt()))
                  }
              }),
              e
            )
            ...
            (e.prototype._getHtml = function (t) {
              return Object(s.b)(this, void 0, void 0, function () {
                ...
                return Object(s.d)(this, function (e) {
                  return null === (t = this._dataProblem.value()) ? [2, null] : [2, [Object(Rt.b)(t.text)]]
                })
              })
            }),
            (e.prototype._updateStatus = function (t) {
                    ...
                    case 1:
                      return (
                        null !== (i = s.sent()) &&
                          ...
                          ('pre_market' === e && this._options.preMarketSolution && i.push(Ci),
                          'post_market' === e && this._options.postMarketSolution && i.push(Ci)),
                        [2, i]
                      )
                  }
                })
      ...
      var ki = (function () {
          ...
          return (
            ...
            (t.prototype._updateDropdownMenu = function () {
              var t = this
              Promise.all([i.e('react'), i.e(6), i.e(20), i.e(98), i.e(0), i.e(3), i.e('full-tooltips-popup')])
        ...
        Ni = (function () {
          function t(t, e, i, o, n, r) {
            ...
            ;(this._mainSeriesViewModel = null),
              ...
              (this._dataSourceViewModelsOptions = Object(s.a)(Object(s.a)({}, this._mainSeriesViewModelsOptions), {
            ...
            _.subscribe(this, function () {
              ...
              (this._updateCollapsedSourcesModeThrottle = Bi()(this._updateCollapsedSourcesMode.bind(this), 100)),
          ...
          return (
                ...
                n > -1
                  ? (i.splice(n, 1),
                    Pi ||
                      ...
                      (this._mainSeriesStatusWidget = new Wi(s, this._model.model(), this._options.statusesWidgets)),
                  ...
                  if (t > n + 1) {
                    for (var l = '', a = 0; a < t; a++) {
                      ...
                      this._dataSourceViewModels[a].setGlobalVisibility(r),
                        r || (l += (0 === l.length ? '' : ', ') + this._dataSourceViewModels[a].getFullTitle())
                    }
                    return (
                      this._collapsedDataSourcesTitle.setValue(l), void this._collapsedDataSourcesCount.setValue(t - n)
                    )
                  }
                }
              }
            ...
            (t.prototype._getCustomWidgetsHeight = function () {
              for (var t = 0, e = 0, i = Array.from(this._customLegendWidgetsMap.values()); e < i.length; e++)
                for (var s = i[e], o = 0, n = Array.from(s.values()); o < n.length; o++)
                  for (var l = 0, a = n[o]; l < a.length; l++) {
                    t += a[l].height().value()
                  }
              ...
              if (void 0 !== e) {
                for (
                  ...
                  for (var l = n[o], a = i.get(l) || [], r = e.get(l) || [], u = a.length; u < r.length; u++) {
                    ...
                    0 === t && 0 === l && d.setGlobalVisibility(this._hideNotMainSources.opposite()),
                      a.push(d),
