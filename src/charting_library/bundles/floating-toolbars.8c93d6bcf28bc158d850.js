        ...
        o('m/4m'),
          ...
          (T.prototype._onPropertyChangedInToolbar = function (t, e) {
            ...
            this._currentProperties &&
              (this._trackContextAction(t), this.activeChartWidget().model().setProperty(this._currentProperties[t], e))
          }),
            ...
            if (
              ...
              if (1 === t.length) {
                ...
                y(e) && e.isAvailableInFloatingWidget() && this.findSourceOnWidget(e)
                  ? (!e.userEditEnabled() || (!_(e.toolname) && this.activeChartWidget().model().lineBeingCreated())
                      ? this._hideAllSourceActions()
          ...
          (T.prototype._createWidthsButton = function (t, e) {
            var o
            if (
              (this._lineWidthsProperty && (this._lineWidthsProperty.destroy(), (this._lineWidthsProperty = null)), e)
            ) {
          ...
          (T.prototype._createColorsButton = function (t, e) {
            if (
              (this._lineColorsProperty && (this._lineColorsProperty.destroy(), (this._lineColorsProperty = null)), e)
            ) {
            ...
            return (
              ...
              this._floatingToolbar.addWidget(this._$colorsButtons[0], { index: this._$templatesButton ? 1 : 0 }),
          ...
          (T.prototype._createBackgroundsButton = function (t, e) {
            ...
            return (
              (this._$backgroundsButtons = this.colorPropertyControl(
                ...
                { title: window.t('Line tool backgrounds'), iconSvgCode: U, name: 'Set multiple colors' },
                null,
              )),
              this._floatingToolbar.addWidget(this._$backgroundsButtons[0], { index: this._$templatesButton ? 1 : 0 }),
          ...
          (T.prototype._createTextColorsButton = function (t, e) {
            if (
              (this._textColorsProperty && (this._textColorsProperty.destroy(), (this._textColorsProperty = null)), e)
            ) {
              var o = this.selectedSources().filter(function (t) {
            ...
            return (
              (this._$textColorsButtons = this.colorPropertyControl(
                ...
                { title: window.t('Line tool text colors'), iconSvgCode: Z, name: 'Set multiple colors' },
                null,
              )),
              this._floatingToolbar.addWidget(this._$textColorsButtons[0], { index: this._$templatesButton ? 1 : 0 }),
          ...
          (T.prototype.showPropertiesOf = function (t, e, o) {
            ...
            if ((this._clearProperties(), (this._propertiesVisible = !1), i.length)) {
              for (var n = {}, r = i.length - 1; r >= 0; --r) {
                for (var s = i[r], a = e, l = s.name.split('.'), d = 0; d < l.length; ++d) a = a && a[l[d]]
                var c = s.showIf
                if ('function' != typeof c || c(a, e)) {
                  ...
                  if ('combobox' !== s.inputType) {
                    ...
                    this._floatingToolbar.addWidget(h[0], { index: this._$templatesButton ? 1 : 0 }),
                      this._toolbarWidgets.push(h)
                    continue
                  }
                  s.simple ? s.comboboxOptions.forEach(B.bind(null, u)) : s.comboboxOptions.forEach(L.bind(null, u)),
          ...
          (T.prototype._clearProperties = function () {
            ;-1 !== this._floatingToolbar.findGroupedWidget('linewidth') &&
              ...
              this._$colorsButtons &&
                (this._floatingToolbar.removeWidget(this._$colorsButtons[0]), delete this._$colorsButtons),
              this._$backgroundsButtons &&
                (this._floatingToolbar.removeWidget(this._$backgroundsButtons[0]), delete this._$backgroundsButtons),
              this._$textColorsButtons &&
                (this._floatingToolbar.removeWidget(this._$textColorsButtons[0]), delete this._$textColorsButtons),
          ...
          (T.prototype.colorPropertyControl = function (t, e, o) {
            ...
            return (
              this.bindControl(
                new a(i, t, !0, this.activeChartWidget().model(), null, T.getTransparency(e, o), function (t) {
                  var e = l.activeChartWidget().model()
                  e.beginUndoMacro(this._undoText), e.setProperty(this.property(), t), e.endUndoMacro()
                }),
              ),
        ...
        ;(T.prototype._defaultToolProperties = function () {
          ...
          (T.prototype._textPropertiesExceptionCases = function () {
            return [
              ...
              { name: 'borderColor', title: $.t('Border Color'), inputType: 'colorPicker', iconSvgCode: G },
              { name: 'bordercolor', title: $.t('Border Color'), inputType: 'colorPicker', iconSvgCode: G },
              {
                name: 'fontsize',
                title: $.t('Font Size'),
          ...
          (T.prototype._notePropertiesExceptionCases = function () {
            return [
              { name: 'markerColor', title: $.t('Marker Color'), inputType: 'colorPicker', iconSvgCode: G },
              { name: 'textColor', title: $.t('Text color'), inputType: 'colorPicker', iconSvgCode: Z },
              {
                name: 'fontSize',
                title: $.t('Font Size'),
          ...
          (T.prototype._trackContextAction = function (t) {
            ...
            const o =
              null === this.activeChartWidget().model().lineBeingCreated() && l.toolIsCursor(e)
                ? 'Context action on drawings'
                : 'Context action before finishing drawings'
            b('GUI', o, t)
          }),
          (T.prototype._createToolExceptionCases = function () {
            return {
              ...
              LineToolBarsPattern: [{ name: 'color', title: K, inputType: 'colorPicker', iconSvgCode: U }],
              LineToolProjection: [
                {
                  name: 'color1',
