          ...
          R = (function () {
            ...
            function m(i) {
              ...
              for (
                ...
                t[s].immediate ? $(this._inputElement).on(t[s].name, n) : $(this._inputElement).on(t[s].name, o)
            ...
            ;(m.registerAutoFocus = function (t) {
              ...
              (m.prototype._moveSelection = function (t, e) {
                if (this.$list) {
                  var i,
                    ...
                    s = n.find('tr.symbol-edit-popup-active').removeClass('symbol-edit-popup-active'),
                    r = 0 !== s.length ? o.index(s) : -1
                  if (r !== (i = 1 === t ? (s.get(0) === o.get(-1) ? 0 : r + t) : Math.max(-1, r + t))) {
                    var a = o.get(i)
                    if (a) {
              ...
              (m.prototype._eventListener = function (t, i) {
                ...
                var s = !1,
                  r = !1
                this._state.value !== o &&
                  (this._state.hasOwnProperty('value') && this._onValueChanged && this._onValueChanged(o),
                  (this._state.value = o),
                  (s = !0),
              ...
              (m.prototype._onSelectionChanged = function (t, e) {
                ...
                if (
                  ...
                  this._isSpreadInInput() && this._state.contextToken && (s = this._state.contextToken.value),
                    o(s, this.getExchangeFilter(), this._state.typeFilter, s, this._state.tradableFilter)
                }
              }),
              ...
              (m.prototype._groupContracts = function (t) {
                for (var e = ChartApiInstance.symbolsGrouping(), i = {}, n = [], o = 0; o < t.length; ++o) {
                  var s = t[o]
                ...
                if (e.highlightedItem) {
                  ...
                  if (this._isSpreadInInput() || (this._inputParserMixin && !0 !== t)) {
                    ...
                    (this._state._selectedTicker = i.ticker || i.symbol),
                      ...
                      (o = (n = !0 === t && i.full_name && this._inputParserMixin ? i.full_name : i.symbol).length)
              ...
              (m.createSuggestListRow = function (t, e, i, n) {
                ...
                if (w && t.contractDescription) {
                  ...
                  h += d ? ' (' + T(i, d[1]) + ' ' + d[2] + ')' : ' (' + T(i, t.contractDescription) + ')'
                }
            ...
            return (
              (m.showDialog = function (t) {
                ...
                if (!d.get('Symbol Search')) {
                  ...
                  if (
                    ...
                    t.ignoreInterval || ((n = m.getInputValueGetter(a)), (o = m.getInputValueSetter(a))),
                          ...
                          n = (function (t, e, i) {
                            ...
                            var u = o.outerHeight(),
                              ...
                              f =
                                ...
                                (a.top - h) -
                                d / 2
                            return s.css('maxHeight', f - d - u + 'px'), { popup: n, listWrapper: s }
                          })(k, t, i.position)
                        ;(_ = n.popup),
              ...
              (D.prototype.append = function (t) {
                ...
                ;(i = D.itemTicker(t)), (this._itemsByTicker[i] = t), e.setAttribute('data-item-ticker', i)
              }),
              ...
              (m.detachStoreInterval = function (t) {
                ...
                return e ? ((A = e.detached), (F = _.normalize(A)), e.rest) : (m.resetStoredInterval(), t)
              }),
