                      ...
                      for (h = 0; h < L.length; ++h)
                        (S = L[h]),
                          ~C.CHILD_STUDY_ALLOWED_PLOT_TYPES.indexOf(S.type) &&
                            (p[k + '$' + h] = g + ': ' + ((x && x[S.id] && x[S.id].title) || S.id))
                    }
                  }
                }
                ;(s = (function (t) {
          ...
          (T.prototype.prepareLayoutImpl = function (t, e) {
            ...
            for (var o = this._sortInputs(t.inputs), r = 0; r < o.length; r++) {
              ...
              if (
                ...
                if (p.options) this.bindControl(new y(k, this._property.inputs[C], null, !0, this.model(), m, P, x))
                  ...
                  L = [c(p.defval)]
                  ;(0 === p.min || p.min) && L.push(l(p.min)), (0 === p.max || p.max) && L.push(d(p.max))
        ...
        (x.prototype._prepareLayoutForPalette = function (t, e, i, o, n, a) {
          ...
          for (var b in i.colors) {
            ...
            if (
              ...
              k.appendTo(g), this.bindControl(new u(k, f.width, !0, this.model(), n, this._study.metaInfo().isTVScript))
              var P = $('<td>')
              if ((P.appendTo(C), 0 === y)) {
                var x = T()
