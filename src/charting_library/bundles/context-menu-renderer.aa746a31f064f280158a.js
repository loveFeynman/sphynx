            ...
            return (
              ...
              (n._handleClick = function (e) {
                e.isDefaultPrevented() ||
                  ...
                  (n._hasSubItems()
                    ? n._showSubMenu()
                    : (n.state.doNotCloseOnClick || Object(g.b)(), n.props.action.execute(), n._trackEvent()))
              }),
                      ...
                      r.createElement(A.a, { rule: 'screen and (max-width: 419px)' }, function (t) {
                        return e._isDrawer(t)
                          ? r.createElement(
                              ...
                              r.createElement(z.Provider, { value: t }, r.createElement(J, { items: i })),
                            )
                          : r.createElement(
                              c.a,
                              {
    ...
    l4ku: function (e, t, n) {
      ...
      function m(e) {
        var t = e.isTitle,
          ...
          N = !!S.length
        return n
          ? r.a.createElement('li', { className: i(h.item, h.loading) }, r.a.createElement(s.a, { color: 'gray' }))
          : r.a.createElement(
              'li',
              {
                className: i(
