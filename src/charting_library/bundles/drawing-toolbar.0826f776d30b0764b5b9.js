    ...
    '5f7t': function (e, t, n) {
            ...
            return (
              ...
              (n._checkButtonsVisibility = function () {
                var e = n.state,
                  ...
                  i = n.isAtTop(),
                  a = n.isAtBot()
                i || t ? i && t && n.setState({ isVisibleTopButton: !1 }) : n.setState({ isVisibleTopButton: !0 }),
                  a || o ? a && o && n.setState({ isVisibleBotButton: !1 }) : n.setState({ isVisibleBotButton: !0 })
              }),
              (n.state = { heightContent: 0, heightWrap: 0, isVisibleBotButton: !1, isVisibleTopButton: !1 }),
              n
            )
          }
          return (
                ...
                a.a.createElement(
                  ...
                  h &&
                    a.a.createElement(
                      'div',
                      {
                        className: u()(L.scrollTop, ((o = {}), (o[L.isVisible] = w && v > f), o)),
                  ...
                  h &&
                    a.a.createElement(
                      'div',
                      {
                        className: u()(L.scrollBot, ((i = {}), (i[L.isVisible] = g && v > f), i)),
          ...
          function t(t) {
            ...
            return (
              ...
              (n._handlePressStart = function () {
                if (Modernizr.mobiletouch && !n.props.checkable) n._longPressDelay || n.props.onClickButton()
                else {
                  if (n._doubleClickDelay)
                    return clearTimeout(n._doubleClickDelay), delete n._doubleClickDelay, void n._toggleDropdown(!0)
              ...
              (n._handlePressEnd = function () {
                n._longPressDelay &&
                  ...
                  n.state.isOpened
                    ? n._toggleDropdown(!1)
                    : n.props.checkable || n.state.isOpened || !n.props.isActive || Modernizr.mobiletouch
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return i.createElement(
                ...
                i.createElement(
                  ...
                  i.createElement(
                    ...
                    Object(o.a)({}, this._getButtonHandlers(), {
                      className: c(G.buttonWrap, { 'apply-common-tooltip common-tooltip-vertical': Boolean(s || u) }),
                  ...
                  !m &&
                    ...
                    i.createElement(
                      'div',
                      {
                        className: c(G.arrow, d && 'apply-common-tooltip common-tooltip-vertical'),
                        title: d,
                ...
                !m &&
                  (f
                    ? g && i.createElement(H.a, { onClose: this._handleClose, position: 'Bottom' }, h)
                    : i.createElement(
                        R.a,
                        {
                          doNotCloseOn: this,
        ...
        q = (function (e) {
            ...
            return (
              (n._renderItem = function (e, t) {
                var o = n.props.isSmallTablet,
                  a = u()(Q.item, o && Q.smallTablet, t && o && n.state.isActive && e === n.state.current && Q.active)
                return i.createElement(
                  'div',
                  {
                    className: a,
          ...
          return (
            ...
            (t.prototype.componentWillUnmount = function () {
              p.tool.unsubscribe(this._onChangeDrawingState), d.onSync.unsubscribe(this, this._onSyncSettings)
            }),
            (t.prototype.render = function () {
              var e = this,
                t = this.props,
                ...
                Object(o.a)(
                  {
                    ...
                    buttonIcon: i.createElement('div', { className: Q.buttonIcon }, String.fromCharCode(s || I[0])),
                    buttonTitle: J.icon,
                    ...
                    onClickWhenGrayed: function () {
                      return Object(b.emit)('onGrayedObjectClicked', { type: 'drawing', name: w.a[a].localizedName })
                    },
                  },
                  h,
                ),
            ...
            return (
              ...
              (n._syncUnzoomButton = function () {
                ...
                t
                  ? (n._boundUndoModel !== t &&
                      (n._boundUndoModel &&
                        n._boundUndoModel.zoomStack().onChange().unsubscribe(null, n._syncUnzoomButton),
                      t.zoomStack().onChange().subscribe(null, n._syncUnzoomButton),
                      (n._boundUndoModel = t)),
          ...
          return (
            ...
            (t.prototype.render = function () {
              return this.state.isVisible
                ? i.createElement(x, { action: this._handleClick, isTransparent: !0, toolName: 'zoom-out' })
          ...
          function t(t) {
            ...
            ;(n._onChangeDrawingState = function () {
              ...
              (n._onAddFavorite = function (e) {
                var t
                n.setState({ favState: Object(o.a)(Object(o.a)({}, n.state.favState), ((t = {}), (t[e] = !0), t)) })
              }),
              (n._onRemoveFavorite = function (e) {
                var t
                n.setState({ favState: Object(o.a)(Object(o.a)({}, n.state.favState), ((t = {}), (t[e] = !1), t)) })
              }),
                ...
                i.createElement(
                  ...
                  r.map(function (t, o) {
                    ...
                    return i.createElement(ne.b, {
                      ...
                      shortcut: !s && t.hotkeyHash ? Object(T.humanReadableHash)(t.hotkeyHash) : void 0,
                      icon: l.icon,
                      isActive: h && u === o,
                      appearAsDisabled: c,
      ...
      var be,
        ...
        we = (function (e) {
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              var e = this,
                t = (this._promise = Object(l.ensureNotNull)(Object(ve.getFavoriteDrawingToolbarPromise)()))
              t.then(function (n) {
                e._promise === t &&
                  ((e._instance = n),
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return i.createElement(
                'div',
                {
                  className: c(Me.toggleButton, 'apply-common-tooltip common-tooltip-vertical', !e && Me.collapsed),
      ...
      function Ke() {
        Object(ae.trackEvent)('GUI', 'Magnet mode', 'Strong'),
          Object(X.saveDefaultProperties)(!0),
          p.properties().childs().magnetMode.setValue(_e.MagnetMode.StrongMagnet),
          p.properties().childs().magnet.setValue(!0),
          Object(X.saveDefaultProperties)(!1)
      }
      var Qe = (function (e) {
          ...
          (t.prototype.componentDidUpdate = function (e, t) {
            ...
            i !== t.isVisible &&
              ...
              t.widgetbarSettled !== a &&
                a &&
                g.CheckMobile.any() &&
                (null === (n = window.widgetbar) || void 0 === n || n.visible().subscribe(this._handleWidgetbarVisible))
          }),
          (t.prototype.render = function () {
            var e,
              t = this,
                            ...
                            i.createElement(
                              ...
                              i.createElement(
                                U,
                                {
                                  ...
                                  buttonIcon: m === _e.MagnetMode.StrongMagnet ? de.a.strongMagnet : de.a.magnet,
