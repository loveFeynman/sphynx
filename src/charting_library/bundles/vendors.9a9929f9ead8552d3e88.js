                    ...
                    return (
                      ...
                      c(i, function (e, n) {
                        var i,
                          ...
                          u = o && n.parse(o),
                          l = n.space || 'rgba'
                        if (u) return (i = r[l](u)), (r[s[l].cache] = i[s[l].cache]), (a = r._rgba = i._rgba), !1
                      }),
                        ...
                        ;(e.cssHooks[n] = {
                          set: function (t, r) {
                            var i,
                              s,
                              a = ''
                            if ('transparent' !== r && ('string' !== e.type(r) || (i = d(r)))) {
                    ...
                    e.fn.extend({
                      ...
                      transfer: function (t, n) {
                        var r = e(this),
                          ...
                          u = o ? s.scrollLeft() : 0,
                          l = i.offset(),
                          c = { top: l.top - a, left: l.left - u, height: i.innerHeight(), width: i.innerWidth() },
                          f = r.offset(),
                    ...
                    try {
                      a
                        ? (i || (2 == e._h && R(e), (e._h = 1)),
                          ...
                          n === t.promise ? l(k('Promise-chain cycle')) : (o = A(n)) ? o.call(n, u, l) : u(n))
                        : l(r)
                    } catch (f) {
                      c && !s && c.exit(), l(f)
                    }
    ...
    BMTb: function (e, t, n) {
      ...
      ;((t = e.exports =
        function (e, t, n, f, d) {
          ...
          } else for (g = m.call(e); !(h = g.next()).done; ) if ((v = i(g, y, h.value, t)) === l || v === c) return v
        }).BREAK = l),
        (t.RETURN = c)
    },
    Blyn: function (e, t, n) {
                        ...
                        left: function (e, t) {
                          ...
                          t.collisionWidth > s
                            ? u > 0 && l <= 0
                              ...
                              : (e.left = l > 0 && u <= 0 ? o : u > l ? o + s - t.collisionWidth : o)
                            : u > 0
                            ? (e.left += u)
                            : l > 0
                            ? (e.left -= l)
                        ...
                        top: function (e, t) {
                          ...
                          t.collisionHeight > s
                            ? u > 0 && l <= 0
                              ...
                              : (e.top = l > 0 && u <= 0 ? o : u > l ? o + s - t.collisionHeight : o)
                            : u > 0
                            ? (e.top += u)
                            : l > 0
                            ? (e.top -= l)
                        ...
                        left: function (e, t) {
                          ...
                          c < 0
                            ? ((n = e.left + d + p + h + t.collisionWidth - a - s) < 0 || n < r(c)) &&
                              (e.left += d + p + h)
                            : f > 0 &&
                              ((i = e.left - t.collisionPosition.marginLeft + d + p + h - u) > 0 || r(i) < f) &&
                              (e.left += d + p + h)
                        },
                        top: function (e, t) {
                          var n,
                            ...
                            h = -2 * t.offset[1]
                          c < 0
                            ? ((i = e.top + d + p + h + t.collisionHeight - a - s) < 0 || i < r(c)) &&
                              (e.top += d + p + h)
                            : f > 0 &&
    ...
    P5fv: function (e, t) {
        ...
        var t,
          ...
          f = function (t) {
            ...
            for (n = 0, r = t.length; n < r; n++)
              (i = t[n]), 'array' === (s = o.type(i)) ? f(i) : 'function' === s && ((e.unique && p.has(i)) || l.push(i))
          },
          d = function (o, s) {
            for (s = s || [], t = !e.memory || [o, s], n = !0, r = !0, u = i || 0, i = 0, a = l.length; l && u < a; u++)
              ...
              if (l)
                for (var t = arguments, n = 0, i = t.length; n < i; n++)
                  for (
                    var o = 0;
                    o < l.length &&
                    (t[n] !== l[o] || (r && o <= a && (a--, o <= u && u--), l.splice(o--, 1), !e.unique));
                    o++
                  );
              return this
            },
      ...
      o.extend({
        ...
        when: function (e) {
          ...
          if (r > 1) {
            for (; n < r; n++)
              t[n] && t[n].promise && o.isFunction(t[n].promise) ? t[n].promise().then(c(n), u.reject, f(n)) : --s
            s || u.resolveWith(u, t)
            ...
            if (void 0 === e) {
              if (this.length && ((f = o.data(u)), 1 === u.nodeType && !o._data(u, 'parsedAttrs'))) {
                for (a = (i = u.attributes).length; l < a; l++)
                  0 === (s = i[l].name).indexOf('data-') && ((s = o.camelCase(s.substring(5))), c(u, s, f[s]))
          ...
          if (y && (p = y.events)) {
            for (t = o.trim(P(t || '')).split(' '), s = 0; s < t.length; s++)
              if (((u = l = (a = E.exec(t[s]) || [])[1]), (c = a[2]), u)) {
                ...
                0 === v.length &&
                  f !== v.length &&
                  ((h.teardown && !1 !== h.teardown.call(e, c)) || o.removeEvent(e, u, y.handle), delete p[u])
              ...
              if (
                ...
                if (
                  ...
                  for (a = 0; a < p.length && !e.isPropagationStopped(); a++)
                    (u = p[a][0]),
                      (e.type = p[a][1]),
                      (d = (o._data(u, 'events') || {})[e.type] && o._data(u, 'handle')) && d.apply(u, t),
                      (d = c && u[c]) && o.acceptData(u) && !1 === d.apply(u, t) && e.preventDefault()
                  return (
                    (e.type = g),
                    r ||
              ...
              for (
                ...
                if (!0 !== r.disabled) {
                  for (a = {}, l = [], i[0] = r, t = 0; t < p; t++)
                    void 0 === a[(f = (c = d[t]).selector)] && (a[f] = c.quick ? A(r, c.quick) : i.is(f)),
                      a[f] && l.push(c)
              ...
              for (
                ...
                (c = u.matches[n]),
                  (g || (!e.namespace && !c.namespace) || (e.namespace_re && e.namespace_re.test(c.namespace))) &&
                    ((e.data = c.data),
                    (e.handleObj = c),
                    void 0 !== (s = ((o.event.special[c.origType] || {}).handle || c.handler).apply(u.elem, h)) &&
          ...
          var f = function (t, r, o, s) {
            ...
            if ((c || (c = l), c || f.error(v || t), '[object Array]' === i.call(c)))
              if (b)
                if (r && 1 === r.nodeType)
                  for (y = 0; null != c[y]; y++)
                    c[y] && (!0 === c[y] || (1 === c[y].nodeType && f.contains(r, c[y]))) && o.push(l[y])
              ...
              for (
                ...
                for (s in p.filter)
                  if (null != (i = p.leftMatch[s].exec(e)) && i[2]) {
                    if (((l = p.filter[s]), (c = i[1]), (o = !1), i.splice(1, 1), '\\' === c.substr(c.length - 1)))
                      continue
                    ...
                    if (i)
                      for (d = 0; null != (u = m[d]); d++)
                        u &&
                          ((h = r ^ (a = l(u, i, d, m))),
                          n && null != a ? (h ? (o = !0) : (m[d] = !1)) : h && (v.push(u), (o = !0)))
                    if (void 0 !== a) {
                  ...
                  for (var r in ((f = function (t, r, i, o) {
                    if (((r = r || n), !o && !f.isXML(r))) {
                      ...
                      if (9 === r.nodeType) {
                        ...
                        try {
                          if (!h || d) return _(r.querySelectorAll("[id='" + c + "'] " + t), i)
                        } catch (v) {
                        } finally {
            ...
            if (this[0]) {
              if (
                ...
                for (var c = 0, f = this.length, d = f - 1; c < f; c++)
                  n.call(t ? ae(this[c], i) : this[c], r.cacheable || (f > 1 && c < d) ? o.clone(s, !0, !0) : s)
              }
              l.length &&
          ...
          style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
              ...
              if (
                ...
                null == n ||
                  ('number' === s && isNaN(n)) ||
                  ('number' !== s || o.cssNumber[a] || (n += 'px'), l && 'set' in l && void 0 === (n = l.set(e, n))))
              )
                try {
                  u[t] = n
                } catch (c) {}
                      ...
                      ;(m = (function (e, t) {
                        ...
                        for (n = 1; n < p; n++) {
                          ...
                          if (((s = h), '*' === (h = f[n]))) h = s
                            ...
                            if (!(u = d[(a = s + ' ' + h)] || d['* ' + h]))
                              for (l in ((c = void 0), d))
                                if (((i = l.split(' '))[0] === s || '*' === i[0]) && (c = d[i[1] + ' ' + h])) {
                                  !0 === (l = d[l]) ? (u = c) : !0 === c && (u = l)
                                  break
                                }
                            u || c || o.error('No conversion from ' + a.replace(' ', ' to ')),
                              !0 !== u && (t = u ? u(t) : c(l(t)))
                          }
                        }
                        return t
                    ...
                    l
                      ? ((f = parseFloat(l[2])),
                        'px' !== (d = l[3] || (o.cssNumber[r] ? '' : 'px')) &&
                          (o.style(this, r, (f || 1) + d), (c = ((f || 1) / s.cur()) * c), o.style(this, r, c + d)),
                        l[1] && (f = ('-=' === l[1] ? -1 : 1) * f + c),
                        s.custom(c, f, d))
                      : s.custom(c, n, ''))
            return !0
          ...
          return (
            d(e, [
              ...
              },
              {
                key: 'create',
                value: function (t) {
                  return new e(this.logger, l({}, { prefix: ''.concat(this.prefix, ':').concat(t, ':') }, this.options))
                },
              },
            ]),
            e
            ...
            d(t, [
              ...
              },
              {
                ...
                value: function (e, t, n, r, i) {
                  ...
                  var a = N(this.data, s) || {}
                  r ? j(a, n, i) : (a = l({}, a, n)), C(this.data, s, a), o.silent || this.emit('added', e, t, n)
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  if (w && g && x && b.indexOf(y) < 0 && ('string' != typeof _ || '[object Array]' !== y)) {
                    ...
                    if (O || N || L) {
                      if ((this.logger.log(L ? 'updateKey' : 'missingKey', f, c, s, L ? t.defaultValue : g), i)) {
              ...
              },
              {
                ...
                value: function (e, t, n, r) {
                  ...
                  for (s = 0; (i = this.regexpUnescape.exec(e)); ) {
                    ...
                    if (((e = e.replace(i[0], l(o))), (this.regexpUnescape.lastIndex = 0), ++s >= this.maxReplaces))
                      break
                  }
                ...
                value: function () {
                  ...
                  if (
                    ...
                    ;(o.logger = w),
                      ...
                      (o.backendConnector = new $(r(this.modules.backend), o.resourceStore, o, this.options)),
        ...
        ;(l.abs = function () {
          ...
          (l.minus = l.sub =
            function (e) {
              ...
              if ((a = c - d)) {
                for ((i = a < 0) ? ((a = -a), (r = l)) : ((d = c), (r = f)), r.reverse(), u = a; u--; ) r.push(0)
                r.reverse()
              } else
