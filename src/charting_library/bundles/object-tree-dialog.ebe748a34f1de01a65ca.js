  ...
  ['object-tree-dialog'],
  {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = function (e) {
          return function (t) {
            ...
            c(o, a, d)
            var f = a.getItemType()
            return s(o, d, f), l(o, a, d), { type: i.HOVER, payload: { targetIds: o, clientOffset: r || null } }
          }
        })
      var r = a(n('QLaP')),
        o = a(n('gGVb')),
        ...
        (t.DragLayer = function (e) {
          ...
          return (
            ...
            function (n) {
                            ...
                            return void 0 === n
                              ...
                              : (e.receiveDragDropManager(n),
                                e.isCurrentlyMounted
                                  ? r.createElement(
                                      c,
                                      Object.assign({}, e.props, e.state, { ref: (0, s.isRefable)(c) ? e.ref : null }),
                                    )
                                  : null)
                          })
                        },
              ...
              return (m.displayName = 'DragLayer('.concat(h, ')')), (m.DecoratedComponent = n), (0, i.default)(m, n)
            }
          )
        })
      var r = (function (e) {
    ...
    b4AZ: function (e, t, n) {
      ...
      var r = n('mrSG'),
        ...
        b = n('x5pF'),
        y = function (e) {
          return Object(s.t)('{drawingsCount} drawing', { plural: '{drawingsCount} drawings', count: e }).format({
                      ...
                      return (
                        this._model &&
                          ...
                          (n = this._symbolDrawingsMap.get(e)) &&
                            ((o = Array.from(n)
                              .map(function (e) {
                                return Object(i.ensureNotNull)(a._model).model().dataSourceForId(e)
                              })
                              .filter(p.notNull)),
                ...
                (n._updateItems = function () {
                  return Object(r.b)(n, void 0, void 0, function () {
                    ...
                    return Object(r.d)(this, function (t) {
                      switch (t.label) {
                        case 0:
                          return null === this._model ? [3, 2] : [4, this._getItems(this._model.model().dataSources())]
                        case 1:
            ...
            return (
                    ...
                    return Object(r.d)(this, function (n) {
                      switch (n.label) {
                        ...
                        case 1:
                          return (
                            (e = n.sent()),
                            this.setState({ currentSymbol: this._model.mainSeries().symbol(), items: e }, function () {
                              var e, n
                              return null === (n = (e = t.props).onInitialized) || void 0 === n ? void 0 : n.call(e)
                            }),
                            [2]
                          )
                      }
              ...
              (t.prototype.render = function () {
                ...
                return o.createElement(
                  o.Fragment,
                  null,
                  null === this._storageContent ? null : o.createElement('div', { className: b.title }, c),
                  null === a || 0 === a.length
              ...
              (t.prototype._getItems = function (e) {
                return Object(r.b)(this, void 0, void 0, function () {
                  ...
                  return Object(r.d)(this, function (r) {
                    switch (r.label) {
                      case 0:
                        return (t = []), (n = this._getSymbolDrawingsMap(e)), [4, this._getStorageContent()]
                      case 1:
                        return (
                          ...
                          this._symbolDrawingsMap.forEach(function (e, n) {
                            t.push({ symbol: n, drawingsCount: e.size }), (o._totalCount = o._totalCount + e.size)
                          }),
                          [
                            2,
                            t.sort(function (e, t) {
    ...
    laIQ: function (e, t, n) {
      ...
      var f = (function () {
        function e() {
          ...
          var r = d(n)
          ;(this.store = r), (this.monitor = new a.default(r, new u.default(r))), r.subscribe(this.handleRefCountChange)
        }
        var t, n, r
        return (
          (t = e),
    ...
    mGlc: function (e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.getDragPreviewOffset = function (e, t, n, r, u) {
          ...
          var _
          return {
            x: 0 === y || y ? y : new i.default([0, 0.5, 1], [l.x, (l.x / d) * g, l.x + g - d]).interpolate(p),
            y: O
              ? m
    ...
    td7b: function (e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = function (e) {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      if (this.handlerMonitor && this.manager && this.handlerConnector && e !== this.currentType) {
                        ...
                        var u = this.manager.getMonitor().subscribeToStateChange(this.handleChange, { handlerIds: [i] })
          ...
          return (j.DecoratedComponent = t), (j.displayName = ''.concat(b, '(').concat(w, ')')), (0, a.default)(j, t)
        })
      var r = (function (e) {
          if (e && e.__esModule) return e
          var t = d()
    ...
    xNz2: function (e, t, n) {
      ...
      var ne =
          (te((J = {}), G.mouse, { start: 'mousedown', move: 'mousemove', end: 'mouseup', contextmenu: 'contextmenu' }),
                    ...
                    if (
                      ...
                      for (var h in f)
                        if (f.hasOwnProperty(h)) {
                          var v = f[h]
                          for (p.push(v); v; ) (v = v.parentElement), -1 === p.indexOf(v) && p.push(v)
                        }
                      var g = p
                        .filter(function (e) {
                      ...
                      if (c)
                        for (var b in o.targetNodes)
                          if (o.targetNodes[b] && o.targetNodes[b].contains(l) && -1 === g.indexOf(b)) {
                            g.unshift(b)
                            break
                          }
                ...
                ;(n = function () {
                  ...
                  return Object(r.d)(this, function (y) {
                    switch (y.label) {
                      ...
                      case 1:
                        return (
                          (n = y.sent()), (o = n.mode), (i = n.nodeId), (a = n.isSelected), (c = ut), [4, Object(j.f)()]
                        )
                      case 2:
                        return (u = r.f.apply(void 0, [c.apply(void 0, [y.sent()])])), (l = ft), [4, Object(j.f)()]
                      case 3:
                        return (
                          (s = l.apply(void 0, [y.sent()])),
                          1 !== o ? [3, 4] : (a ? u.push(i) : u.splice(u.indexOf(i), 1), [3, 7])
                        )
                      case 4:
          ...
          switch (r.label) {
            ...
            case 3:
              return (
                ...
                (a = o.dropType),
                i && a
                  ? ((c = new CustomEvent('tree-node-drop', { detail: { nodes: t, target: i.id, type: a } })),
                    e && e(c),
        ...
        nodes: function (e, t) {
          ...
          switch ((void 0 === e && (e = {}), t.type)) {
              ...
              for (var l = 0, d = o; l < d.length; l++) {
                ...
                if (a.hasOwnProperty(p))
                  !Object(Et.deepEquals)(a[p].children, f.children)[0] &&
                    (a[p] = Object(r.a)(Object(r.a)({}, a[p]), { children: Object(r.f)(f.children) }))
            ...
            case le:
              ...
              return Object(r.a)(Object(r.a)({}, e), (((n = {})[h] = Object(r.a)(Object(r.a)({}, e[h]), v)), n))
            case de:
              var g = t.nodes,
                b = Object(r.a)({}, e)
              return (
      ...
      var vn = Object(ie.DragLayer)(function (e) {
          ...
          Object(z.b)(
            ...
            return rn(function () {
              ...
              var c = (((a = {})[pn.dropTarget] = 'inside' !== t), (a[pn.dropTargetInside] = 'inside' === t), a),
                s = n.width,
                l = n.height,
                d = u(e),
                f = d[0],
      ...
      var _n = i.a.forwardRef(function (e, t) {
          ...
          Object(o.useEffect)(
            function () {
              var e = function (e) {
                  ;[Lt.Modifiers.Mod, Lt.Modifiers.Shift].includes(Object(Lt.modifiersFromEvent)(e)) && c()
                },
                t = function (e) {
                  s && ![Lt.Modifiers.Mod, Lt.Modifiers.Shift].includes(Object(Lt.modifiersFromEvent)(e)) && u()
                }
              return (
                ...
                for (var r = 0; r < a.length; r++) {
                  ...
                  1 === o.level &&
                    (void 0 !== e &&
                      ...
                      n.push({
                        type: 'separator',
                        node: i.a.createElement('div', { key: e + '_separator', className: yn.separator }),
                      }),
                    (e = o.parentId)),
                    n.push({
                      type: 'node',
          ...
          var B = Object(o.useCallback)(function (e) {
              ...
              return (
                n === L.current.length - 1 &&
                  delete (t = Object(r.a)(Object(r.a)({}, t), { bottom: 0, minHeight: t.height })).height,
          ...
          var Q = Object(o.useRef)(null),
            ...
            Z = Object(o.useRef)({
              startScroll: function (e) {
                var t = function () {
                  null !== W.current && ((Y.current = requestAnimationFrame(t)), W.current.scrollBy({ top: e }))
                }
                this.stopScroll(), t()
              },
              stopScroll: function () {
      ...
      function Pn() {
        ...
        return Object(r.d)(this, function (t) {
          switch (t.label) {
            ...
            case 1:
              return (
                1 === (e = t.sent().mode) && Cn('Multi select', 'Ctrl'), 2 === e && Cn('Multi select', 'Shift'), [3, 0]
              )
            case 2:
              return [2]
          }
      ...
      function tr(e) {
        ...
        if (l) {
          var Q = V.entity(l)
          Q && (K['data-parent-name'] = Q.title()), (K['data-type'] = d.hasChildren() ? 'group' : 'data-source')
        }
        ...
        return i.a.createElement(
            ...
            onClick:
              1 === v
                ...
                : function (e) {
                    ...
                    if (U.current)
                      e.preventDefault(), clearTimeout(U.current), (U.current = null), V.openProperties(d), z(!1)
                    else {
          ...
          !Z &&
            i.a.createElement(
              o.Fragment,
              null,
              q && q.type === Un.Svg && i.a.createElement(E.a, { icon: q.content || '', className: $n.icon }),
              q && q.type === Un.Text && i.a.createElement('span', { className: T($n.icon, $n.textIcon) }, q.content),
              i.a.createElement(
                'span',
                Object(r.a)({ className: T($n.title, V.isMain(d) && $n.main, !d.isVisible() && $n.disabled) }, K),
                X,
              ),
              (Y || C || !P || J || !R) &&
                i.a.createElement(
                  ...
                  (Y || !P || !R) &&
                    i.a.createElement(Kn, {
                      icon: ee,
                      className: T($n.button, $n.viewButton, !R && [$n.warn, 'apply-common-tooltip']),
                      onClick: R
                        ? function (e) {
                            if (e.defaultPrevented) return
          ...
          function t(t) {
            ...
            return (
              ...
              (n._handleMediaChange = function () {
                n.state.showDrawer && !window.matchMedia(O.a.TabletSmall).matches && n.setState({ showDrawer: !1 })
              }),
              ...
              return i.a.createElement(
                ...
                i.a.createElement(b.a, { rule: O.a.TabletSmall }, function (t) {
                  return i.a.createElement(m.a, {
                    ...
                    isOpened: !0,
                    onClickOutside:
                      e.state.showDialog || t || e.state.isContextMenuOpened ? function () {} : e.props.onClose,
      ...
      var Tr = new cr.a(),
        Cr = (function () {
          ...
          return (
            ...
            (e.prototype.onIsActualIntervalChange = function () {
              return Object(fr.isLineTool)(this._dataSource) ? this._dataSource.onIsActualIntervalChange() : Tr
            }),
            (e.prototype.isLocked = function () {
              return !!Object(fr.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value()
            }),
            ...
            (e.prototype.onLockChanged = function () {
              return Object(fr.isLineTool)(this._dataSource) ? this._dataSource.properties().frozen.listeners() : Tr
            }),
                ...
                null !== a
                  ? (Object(D.assert)(
                    ...
                    i.forEach(function (e) {
                      Object(fr.isLineTool)(e) && (a.containsLineTool(e) || r.addLineToolToGroup(a, e))
                    }))
                  : o()
              } else o()
        ...
        Ir = (function () {
          function e(e) {
            ;(this._controller = e), (this._facade = new Mr(e)), (this._groupModel = e.model().lineToolsGroupModel())
          }
          return (
            (e.prototype.buildTree = function () {
              for (var e = {}, t = {}, n = 0, o = this._controller.model().panes(); n < o.length; n++) {
                ...
                for (var u = 0, c = this._groupModel.groups(); u < c.length; u++) {
                  ...
                  if (l.pane() === i) {
                    ...
                    for (var f = 0, p = d; f < p.length; f++) {
                      var h = p[f]
                      ;(t[h] = Object(D.ensureNotNull)(this._facade.getObjectById(h))), (e[h] = Pr(h, 2, l.id()))
                    }
                  }
                }
                ...
                e[i.id()].children.sort(function (e, n) {
                  return Object(D.ensureNotNull)(t[e].zOrder()) > Object(D.ensureNotNull)(t[n].zOrder()) ? -1 : 1
                })
              }
      ...
      var Wr = (function () {
          ...
          return (
            ...
            (e.prototype.cloneSelection = function () {
              ...
              n.every(fr.isLineTool) && (this._controller.cloneLineTools(Object(r.f)(n), !1), Cn('Clone', En(t)))
            }),
              ...
              return Object(r.b)(this, void 0, void 0, function () {
                ...
                return Object(r.d)(this, function (r) {
                  switch (r.label) {
                    ...
                    case 1:
                      return [4, this._facade.contextMenuActions(this._chart.value(), this._objects, this._options)]
                    case 2:
                      ;(a = r.sent()),
                        (i = Array.from(a).filter(function (e, t, n) {
                          return e.type !== Nr.a.Separator || !n[t + 1] || n[t + 1].type !== Nr.a.Separator
                        })),
                    ...
                    case 3:
                      return (
                        i.length > 0 &&
                          Rn.ContextMenuManager.createMenu(i, { takeFocus: !0, returnFocus: !0 }, function () {
            ...
            (e.prototype.getNextNodeIdAfterRemove = function (e) {
              ...
              return 1 === u.length ? this.getNextNodeIdAfterRemove(r.parentId) : this._takeNextOrPrevElement(u, e)
            }),
            ...
            (e.prototype._getActionsForGroupItem = function (e, t, n) {
              ...
              return (
                1 === this._objects.length && (o.unshift(new xr.Separator()), o.unshift(this._getRenameAction(t))),
            ...
            (e.prototype._normalizeTargetAndDropType = function (e, t) {
              ...
              return (
                'inside' === t && ((t = 'before'), (n = Object(D.ensureDefined)(Object(r.f)(n.children()).shift()))),
                [n, t]
              )
            }),
            (e.prototype._getSelectedEntities = function () {
              ...
              return (
                r.length &&
                  Ur.logWarn('Detected dangling sources in selection. They will be ignored: ' + JSON.stringify(r)),
                n
              )
            }),
      ...
      var Kr = (function (e) {
        function t() {
          ...
          return (t._activeChartWidget = n.activeChartWidget.value()), (t._viewModel = new Wr(n.activeChartWidget)), t
        }
        return (
          Object(r.c)(t, e),
