                ...
                (i._renderChildren = function (e) {
                  ...
                  return e
                    ? a.createElement(
                        a.Fragment,
                        null,
                        a.createElement(j, { ranges: n, activeRange: r, onSelectRange: i._handleRangeSelect }),
                    ...
                    : a.createElement(
                        ...
                        o && a.createElement(f.b, { label: D.goToDate, onClick: i._handleGoToDateClick }),
                      )
                }),
            ...
            function t(t, n) {
              ...
              return (
                (a._handleClick = function () {
                  ...
                  Object(_.trackEvent)('GUI', 'Chart Bottom Toolbar', 'go to'), Object(N.showGoToDateDialog)(e.model())
                }),
                Object(C.c)(n, { chartWidget: c.any.isRequired }),
                a
              )
          ...
          return (
            ...
            (t.prototype.updateTimezonesButton = function () {
              ...
              if (e.model() && null !== e.model().mainSeries().symbolInfo()) {
                ...
                if ('exchange' === t) {
                  var n = Object(b.ensureNotNull)(e.model().mainSeries().symbolInfo()).timezone
                  n && (t = n)
                }
                var a = Object(ae.a)(t)
            ...
            (e.prototype._setHighlight = function () {
              ...
              if (null !== t && null !== n) {
                ...
                if (null !== a) {
                  ...
                  null !== r &&
                    s.value().axis !== r &&
                    (s.setValue({ owner: this._owner, axis: r }), e.lightUpdate(), (this._highlighted = !0))
                }
              }
            }),
            (e.prototype._removeHighlight = function () {
              ...
              if (null !== t) {
                ...
                if (null !== n) {
                  ...
                  null !== i.axis &&
                    i.owner === this._owner &&
                    (a.setValue({ owner: this._owner, axis: null }), e.lightUpdate(), (this._highlighted = !1))
                }
              }
            }),
            e
                ...
                function (e, t, n) {
                  if (a.isValidElement(e) && 'string' != typeof e.type) {
                    ...
                    if ('string' == typeof r.className) {
                      var s = { className: l(r.className, 0 === t && ke.first, t === n.length - 1 && ke.last) },
                        c = i(),
                  ...
                  (s._raf = requestAnimationFrame(function () {
                    ...
                    if ((Object.assign(i, { dateRangeMode: p }), 'expanded' !== p)) {
                      for (
                        ...
                        ;(g += C.width),
                          C.name in Le
                            ? ((f += C.width), Object.assign(i, (((e = {})[C.name] = !1), e)))
          ...
          return (
                ...
                this.props.timeFramesWidgetEnabled &&
                  a.createElement(
                    ...
                    a.createElement(
                      'div',
                      {
                        className: l(ke.dateRangeWrapper, 'collapsed' !== e.dateRangeMode && ke.collapsed),
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        'div',
                        {
                          className: l(ke.dateRangeWrapper, 'expanded' !== e.dateRangeMode && ke.collapsed),
                ...
                a.createElement(
                  ...
                  this.props.timeWidgetEnabled &&
                    a.createElement(
                      ...
                      a.createElement(
                        'div',
                        { className: l(ke.inline, e.timeZones && ke.collapsed), ref: this._handleTimeZonesRef },
                        a.createElement(
                          'div',
                        ...
                        a.createElement('div', { className: ke.inline }, a.createElement(pe, null)),
                      ),
                    ),
                  a.createElement(
                    Me.a,
                    ...
                    this.props.autoScaleButtonEnabled && a.createElement(Oe, { className: ke.item }),
            ...
            (t.prototype._applyResizing = function () {
              ...
              this._rangeExpanded && this._rangeExpanded.classList.toggle(ke.collapsed, 'expanded' !== n),
                this._rangeCollapsed && this._rangeCollapsed.classList.toggle(ke.collapsed, 'collapsed' !== n),
    ...
    l4ku: function (e, t, n) {
      ...
      function m(e) {
        var t = e.isTitle,
          ...
          W = !!S.length
        return n
          ? i.a.createElement('li', { className: r(p.item, p.loading) }, i.a.createElement(s.a, { color: 'gray' }))
          : i.a.createElement(
              'li',
              {
                className: r(
