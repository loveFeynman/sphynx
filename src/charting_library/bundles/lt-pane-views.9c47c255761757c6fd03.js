              ...
              for (T = 0; T < this._levels.length; T++)
                if (T > 0 && N) {
                  var E = this._levels[T - 1],
                    z = ((i = new r(D, this._levels[T].y)), (u = new r(k, E.y)), {})
                  ;(z.points = [i, u]),
          ...
          if ((e.fillText(o, T + d + p + 2 * u + D, M), this._data.status)) {
            ...
            switch (((e.font = w(this._targetFontSize1, this._font, 'bold')), this._data.status)) {
              case f.AlertStatus.Success:
                ;(k = $.t('SUCCESS')),
                  (N = _.generateColor(this._data.successBackground, this._data.transparency)),
                  (B = this._data.successTextColor),
                  (A = this._data.successIcon)
                break
              case f.AlertStatus.Failure:
                ;(k = $.t('FAILURE')),
                  (N = _.generateColor(this._data.failureBackground, this._data.transparency)),
            ...
            ;(e.fillStyle = N),
              'up' === this._data.direction
                ? (y(e, R.x - 1, R.y - j - 2, this._targetWidth + 2, j, 5),
                  ...
                  e.drawImage(A, R.x + z - A.width - 4, R.y - j - 2 + Math.abs(j - A.height) / 2))
                : (y(e, R.x - 1, R.y + this._targetHeight + 2, this._targetWidth + 2, j, 5),
                  e.fill(),
                  (e.fillStyle = B),
                  e.fillText(k, R.x + z + V, R.y + this._targetHeight + 5),
                  e.drawImage(A, R.x + z - A.width - 4, R.y + this._targetHeight + 10 - Math.abs(j - A.height) / 2)),
              e.restore()
          } else e.restore()
        }),
          ...
          return this._adapter._editable && e.x >= this._cache.bodyRight && e.x < this._cache.quantityRight
            ? this._adapter.hasModifyCallback()
              ? new o(o.CUSTOM, {
                  ...
                  tapHandler: this._adapter.callOnModify.bind(this._adapter),
                  tooltip: {
                    text: this._adapter.getModifyTooltip() || c(window.t('Modify Order')),
                    rect: {
                      x: this._cache.bodyRight,
                      y: this._cache.top,
                      w: this._cache.quantityRight - this._cache.bodyRight,
        ...
        (p.prototype._updateImpl = function (e) {
          if (
            ...
            var t = this._points[0].y,
              ...
              s = [new r(i, t)]
            this._selectionData = { points: s, bgColors: this._lineAnchorColors(s), hittestResult: n, visible: !0 }
          }
              ...
              if (null != t) {
                ...
                if (!(this._points.length < 2)) {
                  ...
                  for (R = 0; R < this._levels.length; R++) {
                    var V,
                      H = {
                        points: [(i = new n(E, this._levels[R].y)), (r = new n(z, this._levels[R].y))],
                        width: this._model.timeScale().width(),
                        height: this._source.priceScale().height(),
        ...
        (m.prototype._updateImpl = function () {
          ...
          if (((this._label = null), !(this._source.points().length < 2))) {
            ...
            if (this._secondPoint && this._points.length > 0) {
              ...
              this._angleLabelRenderer.setData(z), S.append(this._angleLabelRenderer)
            }
            0,
              this._secondPoint &&
        ...
        (c.prototype._updateImpl = function () {
          if (
            ...
            for (p = 0; p < this._hlevels.length; p++) {
              ...
              if (((z = new s()).setData(N), R.append(z), C.showLeftLabels.value())) {
                var B = {
                  points: [e],
            ...
            for (p = 0; p < this._vlevels.length; p++) {
              ...
              if (((z = new s()).setData(N), R.append(z), C.showTopLabels.value())) {
                var V = {
                  points: [e],
            ...
            if (i) {
              ...
              if (
                ...
                ;(z = c.compact.value()
                  ...
                  M(this._stopLabelRenderer, E, z, c.stopBackground.value(), I < O ? 'bottom' : 'top', 0)
                ...
                ;(z = c.compact.value()
                  ...
                  M(this._profitLabelRenderer, E, z, c.profitBackground.value(), I < O ? 'top' : 'bottom', 0)
