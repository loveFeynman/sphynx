                        ...
                        u.visible.value() &&
                          a.forEach(function (a) {
                            ...
                            ;(!a.extendRight && Math.max(n, h) < o) ||
                              ...
                              e._data.push({
                                y: t.priceToCoordinate(Object(r.ensureDefined)(a.level), s),
    ...
    Gj0v: function (e, t, i) {
        ...
        return (
          (e.prototype.hitTest = function (e, t) {
            for (
              var i = this._data,
                r = function (r) {
                  if (r.xRange.min >= e.x || e.x >= r.xRange.max || r.yRange.min >= e.y || e.y >= r.yRange.max)
                    return 'continue'
                  var a = r.yRange.min,
                    s = 0
                  ...
                  for (var o = p(r.xRange), l = 0, u = r.bars; l < u.length; l++) {
                    ...
                    a += h.height
                    for (
                      var R = Math.max((d.percentWidth * o) / 100 - h.subBarValues.length, 0), y = 0;
                      ...
                      if (((e.x >= w && e.x <= T) || (e.x >= T && e.x <= w)) && e.y >= x && e.y <= b)
              ...
              i.histograms.forEach(function (r) {
                ...
                if (
                  (r.bars.forEach(function (o) {
                    ...
                    if (l.visible) {
                      if (l.showValues)
                        for (var u = 0; u < o.subBarValues.length; u++) a[u] = (a[u] || 0) + o.subBarValues[u]
      ...
      function m(e, t, i) {
        ...
        if (n && o) (r = e.min), (a = 1)
          ...
          if (!s || !l) throw new Error('Unknown location/direction values: ' + t.location + '/' + t.direction)
          ;(r = i), (a = -1)
        }
          ...
          (e.prototype._prepareStyles = function () {
            ...
            for (var i = 0, r = e; i < r.length; i++) {
              var n = r[i],
                ...
                l = s.colors[1] ? Object(x.generateColor)(s.colors[1].value(), s.transparencies[1].value()) : o
          ...
          (e.prototype._updateDataForRenderers = function (e, t, i) {
            ...
            if (!(e.size <= 0)) {
              ...
              if (
                ...
                this._rendererData.histograms.push({ xRange: l, yRange: f(u[0].yRange.min, d), bars: h })
              }
            }
          }),
          e
                          ...
                          s.forEach(function (a) {
                            ...
                            n < u ||
                              ...
                              e._data.push({
                                ...
                                top: a.extendTop ? void 0 : t.priceToCoordinate(Object(r.ensureDefined)(a.endPrice), l),
                                bottom: a.extendBottom
                                  ? void 0
                                  : t.priceToCoordinate(Object(r.ensureDefined)(a.startPrice), l),
                                color: d.color.value(),
