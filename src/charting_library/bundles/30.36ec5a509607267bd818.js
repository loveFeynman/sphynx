          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return this.state.isCustom
                ? o.createElement(R, { color: t, onSelect: this._handleSelectColor, onAdd: this._handleAddColor })
                : o.createElement(
                    'div',
                    ...
                    a &&
                      o.createElement(
                        ...
                        o.createElement(x.a, { color: t, opacity: l, onChange: this._handleOpacity }),
                      ),
                  )
            }),
          ...
          g = (function () {
            ...
            var r = Object(o.useCallback)(
                function (e) {
                  ...
                  t.some(function (e) {
                    return null !== e && null !== n && Object(d.areEqualRgb)(Object(d.parseRgb)(e), n)
                  }) || (Q.emit('add_new_custom_color', e), Object(K.setJSON)('pickerCustomColors', J(e, t)))
                },
                [t],
              ),
              a = Object(o.useCallback)(
                function (e) {
                  ;(e >= 0 || e < t.length) &&
                    (Q.emit('remove_custom_color', e), Object(K.setJSON)('pickerCustomColors', X(e, t)))
                },
                [t],
              )
            return [t, r, a]
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              ...
              (function () {
                ...
                if (!e) return a.a.createElement('div', { className: s()(w.placeholder, _ && w.hiddenArrow) }, b)
                var n = e.selectedContent || e.content
                if ('string' == typeof n)
                  return a.a.createElement('div', { className: s()(w.selected, _ && w.hiddenArrow) }, n)
                return a.a.createElement('div', { className: s()(w.selected, _ && w.hiddenArrow) }, a.a.cloneElement(n))
              })(),
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              var t = this.props,
                ...
                d = i(p.innerInput, 'large' === c && p.largeFont, Object(l.isRtl)() && !u.isChrome && p.innerInputFix)
              return r.createElement(
                'div',
                { className: h },
                r.createElement(
                  ...
                  r.createElement(
                    'div',
                    { className: i(p.inputContainer, Object(l.isRtl)() && !u.isChrome && p.inputContainerFix) },
