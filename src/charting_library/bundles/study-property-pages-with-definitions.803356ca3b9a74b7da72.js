                    ...
                    if (a(d, o)) {
                      ...
                      if ('resolution' === d.type)
                        f = Object(r.j)(
                          ...
                          { id: 'StudyInput' + h, title: b, options: new c.a(s.resolutionItems) },
                        )
                        ...
                        f = Object(r.o)(
                          { symbol: Object(r.y)(t, O, w, P, 'Change ' + b, s.customSymbolInputSetter) },
                        ...
                        var C = { id: 'StudyInput' + h, title: b, type: 'float' === d.type ? 1 : 0, defval: d.defval }
                        d.min && (C.min = new c.a(d.min)),
                          d.max && (C.max = new c.a(d.max)),
                          void 0 !== d.step && isFinite(d.step) && d.step > 0 && (C.step = new c.a(d.step)),
                          (f = Object(r.i)({ value: Object(r.b)(t, i[d.id], 'Change ' + b) }, C))
                      } else
                        f = Object(r.p)(
                    ...
                    if (1 === l.length) t.push({ value: s, title: i })
                      ...
                      for (
                        var c = l.reduce(function (t, e, r) {
                            ...
                            try {
                              c = Object(n.ensureDefined)(Object(n.ensureDefined)(u)[e.id]).title
                            } catch (p) {
                              c = e.id
                            }
                            return Object(o.a)(Object(o.a)({}, t), (((l = {})[s + '$' + r] = i + ': ' + c), l))
                          }, {}),
                          p = 0,
                          a = Object.keys(c);
                        p < a.length;
        ...
        P = (function (t) {
          ...
          return (
            ...
            (e.prototype.destroy = function () {
              this._source.properties().childs().style.unsubscribeAll(this), t.prototype.destroy.call(this)
            }),
            ...
            (e.prototype._stylePropertyDefinitions = function () {
              ...
              return [Object(r.k)(Object(o.f)([e], this._getSeriesStylesDefinitions()), 'SeriesStyleGroup' + s), i, n]
            }),
